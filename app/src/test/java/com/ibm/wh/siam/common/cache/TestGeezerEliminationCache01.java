 ...
 *
 */
public class TestGeezerEliminationCache01
{
    private static final Logger logger = LoggerFactory.getLogger( TestGeezerEliminationCache01.class );
